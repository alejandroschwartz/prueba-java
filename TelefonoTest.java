...
public class TelefonoTest {
  ...
  public static void main(String args[]) {
    ...
    String[] result1 = Telefono.miSwitch(prueba1.split(""));
    ...
    String[] result2 = Telefono.miSwitch(prueba2.split(""));
    ...
    String[] result3 = Telefono.miSwitch(prueba3.split(""));
    ...
    String[] result4 = Telefono.miSwitch(prueba4.split(""));
